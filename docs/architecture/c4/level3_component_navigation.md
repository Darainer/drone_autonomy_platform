...
|---|---|---|---|
| `navigation_node` | publishes | `/navigation_node/trajectory` | `drone_autonomy_msgs/Trajectory` |
| `navigation_node` | subscribes | `/navigation_node/mission` | `drone_autonomy_msgs/Mission` |
