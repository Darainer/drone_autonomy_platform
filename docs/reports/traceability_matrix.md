...
| MAP-7 | Onboard Post-Flight Consistency Check | Draft | docs/architecture/target/CAP-001-photogrammetry.yaml<br>docs/capabilities/CAP-001-implementation-plan.md<br>docs/capabilities/CAP-001-photogrammetry.md<br>docs/design/DES-004-survey-dataset-recording.md<br>docs/design/DES-005-photogrammetry-pipeline.md<br>docs/test_plans/TP-002-survey-mapping.md | tools/photogrammetry/run_pipeline.py | — | 🟡 planned |
| MAP-8 | Onboard Reconstruction Execution | Draft | docs/architecture/target/CAP-001-photogrammetry.yaml<br>docs/capabilities/CAP-001-implementation-plan.md<br>docs/capabilities/CAP-001-photogrammetry.md<br>docs/design/DES-005-photogrammetry-pipeline.md<br>docs/test_plans/TP-002-survey-mapping.md | tools/photogrammetry/run_pipeline.py | — | 🟡 planned |
